...
switch Action
    case 'init'
        ...
        BpodSystem.GUIHandles.EvidenceStrength = line([0,0],[0,0], 'LineStyle','-','Marker','.','MarkerEdge','k','MarkerFace',[1 1 1], 'MarkerSize',6);
        set(AxesHandle,'TickDir', 'out','YLim', [-1, 3], 'YTick', [0 1],'YTickLabel', {'Right','Left'}, 'FontSize', 16);
